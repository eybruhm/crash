...
export const login = async (email, password, role) => {
  try {
    ...
    // Persist session tokens for authentication
    localStorage.setItem('access_token', access);
    localStorage.setItem('refresh_token', refresh);
    
    // Persist basic user profile for UI display (avoids needing to fetch profile immediately)
    ...
    // Categorize errors for friendly UI feedback
