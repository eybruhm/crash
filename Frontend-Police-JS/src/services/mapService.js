...
export const getMapData = async (options = {}) => {
  try {
    // Construct query parameters for scoping data (e.g., specific office vs all)
    ...
    // Return structured map data including reports, offices, and checkpoints
    return response.data;
    
  } catch (error) {
    console.error('Error fetching map data:', error);
    
    // Handle auth failure specifically for map polling to stop unnecessary retries
