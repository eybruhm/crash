...
const buildQueryString = (filters = {}) => {
  ...
  // Conditionally add parameters if filtering is requested
  ...
  // Normalize category case for backend compatibility (e.g. "violence" -> "Violence")
...
export const mapResolvedCaseToFrontend = (backendCase) => {
  return {
    ...
    // Construct location object with safe fallbacks and formatted string
    location: {
