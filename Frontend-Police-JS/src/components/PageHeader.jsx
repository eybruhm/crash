 ...
 * ============================================================================
 * Purpose: Global application header displayed at the top of authenticated pages.
 * Features:
 * - Displays App Logo and Title
 * - Shows current logged-in officer's station and name
...
const PageHeader = ({ onLogout }) => {
  ...
  // Handle user logout
  // Executes context logout and redirects to login page
  const handleLogout = () => {
    if (onLogout) {
      onLogout()
    } else {
