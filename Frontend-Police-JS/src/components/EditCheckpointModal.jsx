 ...
 * ============================================================================
 * Purpose: Allows officers to modify existing checkpoint details or delete them.
 * Features:
 * - Pre-fills form with existing data
 * - Two-step confirmation for deletion
 * - Handles updates to officers, schedule, and location
 * Input:
 * - checkpoint: The object to edit
 * - onUpdate: Callback for saving changes
 * - onDelete: Callback for removing the checkpoint
 * ============================================================================
 */
...
const EditCheckpointModal = ({ checkpoint, onClose, onUpdate, onDelete }) => {
  // Initialize form state using the passed checkpoint props
  ...
  // State for delete confirmation UI
  const [confirmDelete, setConfirmDelete] = useState(false)

  // Handle form submission
  // Validates input and reconstructs the checkpoint data structure
  const handleSubmit = (e) => {
    ...
    const updatedCheckpoint = {
      ...
      // Split comma-separated officer string back into array
  ...
  // Requires user to click twice to confirm deletion
  const handleDelete = () => {
    if (confirmDelete) {
