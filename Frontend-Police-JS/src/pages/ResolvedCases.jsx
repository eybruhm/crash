 ...
 * RESOLVED CASES PAGE
 * ============================================================================
 * Purpose: Historical archive of all resolved/closed incidents.
 * Features:
 * - List view of past cases
 * - Filtering by Date, Scope, Category, City, Barangay
...
const ResolvedCases = () => {
  ...
  // Computed client-side from the loaded cases for simplicity
