 ...
 * DASHBOARD PAGE
 * ============================================================================
 * Purpose: Main command center for police officers.
 * Features:
 * - Real-time list of active reports
 * - Status updating flow (Pending -> Resolved)
 * - Navigation to Directions, Chat, and Details
 * - Periodic polling for new incidents
 * ============================================================================
 */
...
const Dashboard = () => {
  ...
  // Subsequent polls happen in background
  ...
  // Synchronized with Audio Notifier intervals
  useEffect(() => {
    if (!isAuthenticated) {
   ...
   * Performs lazy loading of full data.
   */
  const handleViewReport = async (report) => {
    ...
    try {
      ...
      // Fallback: show list data if detail fetch fails (allows partial interaction)
   ...
   * Uses optimistic updates for responsiveness
   */
  ...
  // Update distance/eta from modals to list view
