 ...
 * - Support mobile overlay open/close
 * - Support desktop collapse/expand via `SidebarContext`
 * - Provide logout action (clears auth and sends user to /login)
 */
export default function Sidebar() {
  ...
  function handleLogout() {
    // Logout is purely client-side: clear tokens/user, then navigate to login.
    clearAuth()
    ...
    <>
      ...
      {mobileMenuOpen && (
        <div
          ...
          // Clicking the overlay closes the menu (common mobile UX pattern)
      ...
      {/* Mobile Menu Button */}
      <button
        // Only shown on small screens; opens the sidebar overlay
