 ...
 *
 * Responsibilities:
 * - Defines the global layout (sidebar + header + routed content)
 * - Splits unauthenticated route(s) (login) from the authenticated app shell
 * - Wraps protected routes with `RequireAuth`
 */
...
function AppContent() {
  ...
  if (isLoginPage) {
    // Login has its own minimal layout (no sidebar/header) to keep the page focused.
    return (
